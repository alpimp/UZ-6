(() => {
  ...
  var redirect = scriptTag.hasAttribute("data-redirect") ? scriptTag.getAttribute("data-redirect") == "true" : false;
  var backLink = scriptTag.getAttribute("data-backlink");
  var showcaseLink = scriptTag.getAttribute("data-showcaselink") ?? backLink;
  var traceEnabled = scriptTag.hasAttribute("data-traceenabled") ? scriptTag.getAttribute("data-traceenabled") == "true" : false;
  var isOff = scriptTag.hasAttribute("data-isoff") ? scriptTag.getAttribute("data-isoff") == "true" : false;
  document.addEventListener("DOMContentLoaded", function() {
    ...
    trace(
      "Back Button Fix v0.4 by Yellow Web (https://bing.com)",
    ...
    if (!redirect)
      trace(`Showcase link is: ${showcaseLink}`);
    removeAnchors();
